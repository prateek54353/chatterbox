...
import 'package:chatterbox/services/ai_image_generator_service.dart';
import 'package:chatterbox/widgets/typing_indicator.dart';
import 'package:chatterbox/widgets/chat_bubble.dart';

class ImageGeneratorChatScreen extends StatefulWidget {
  final ChatSession session;

  const ImageGeneratorChatScreen({super.key, required this.session});

  @override
  State<ImageGeneratorChatScreen> createState() => _ImageGeneratorChatScreenState();
}

class _ImageGeneratorChatScreenState extends State<ImageGeneratorChatScreen> {
  final TextEditingController _textController = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  final AiImageGeneratorService _aiService = AiImageGeneratorService();
