...
import 'package:chatterbox/services/ai_code_tutor_service.dart';
import 'package:chatterbox/widgets/typing_indicator.dart';
import 'package:chatterbox/widgets/chat_bubble.dart';

class CodeTutorChatScreen extends StatefulWidget {
  final ChatSession session;

  const CodeTutorChatScreen({super.key, required this.session});

  @override
  State<CodeTutorChatScreen> createState() => _CodeTutorChatScreenState();
}

class _CodeTutorChatScreenState extends State<CodeTutorChatScreen> {
  final TextEditingController _textController = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  final AiCodeTutorService _aiService = AiCodeTutorService();
